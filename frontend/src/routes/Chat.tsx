    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <nav className="flex justify-between items-center p-4 bg-white shadow-md">
          ...
          <div className="hidden md:flex space-x-4">
            {[
              ...
              <Link
                key={item.name}
                to={item.path}
                className="relative group px-3 py-2 text-gray-700 hover:text-gray-900 transition-colors"
              >
                {item.name}
        ...
        <div className="flex items-center space-x-2">
          {file && (
            <div className="hidden md:flex items-center space-x-2 bg-blue-100 px-3 py-1 rounded-full">
          ...
          <button
            ...
            className="relative p-2 text-gray-700 hover:text-gray-900 bg-gray-100 rounded-full transition-colors"
            title="Upload PDF"
          >
          ...
          <button className="md:hidden p-2 text-gray-700 hover:text-gray-900 bg-gray-100 rounded-full transition-colors">
      ...
      >
        <div className="flex space-x-2">
          <button
            ...
            className="p-2 text-gray-700 hover:text-gray-900 bg-gray-100 rounded-full transition-colors"
          ...
          <input
            ...
            className="flex-1 p-2 bg-gray-100 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button
            type="submit"
            disabled={isLoading}
